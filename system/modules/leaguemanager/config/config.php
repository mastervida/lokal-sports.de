...
(
 ...
 (
   'vi_leagues' => array
   (
     'tables' => array('tl_leagues', 'tl_leagues_rounds', 'tl_leagues_matches'),
     'icon'   => 'system/modules/leaguemanager/html/volleyball.png',
     'stylesheet' => 'system/modules/leaguemanager/scripts/leaguemanager.css',
     'javascript' => array('system/modules/leaguemanager/scripts/leaguemanager.js')
   )
 )
));
 ...
 */
$GLOBALS['BE_FFL']['scoreWizard'] = 'ScoreWizard';
