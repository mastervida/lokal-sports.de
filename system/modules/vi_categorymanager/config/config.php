...
(
 ...
 (
   'vi_categorys' => array
   (
     'tables' => array('tl_categorys'),
     'icon'   => 'system/themes/default/images/modules.gif',
//      'stylesheet' => 'system/modules/categorymanager/html/leaguemanager.css',
//      'javascript' => array('system/modules/categorymanager/html/leaguemanager.js')
   )
 )
));
 ...
 * FRONT END MODULES
 */
$GLOBALS['FE_MOD']['navigationMenu']['topNav'] = 'ModuleTopNavigation';
 ...
 */
$GLOBALS['TL_PTY']['dependTo'] = 'PageDepend';
